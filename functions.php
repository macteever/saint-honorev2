...
function html5blank_conditional_scripts()
{
    ...
    if (is_page_template( array('templates/template-contact.php') )){
        wp_register_script('contact-script', get_template_directory_uri() . '/assets/js/contact.js', array('jquery'), false, false); // Custom contact script
        wp_enqueue_script('contact-script'); // Enqueue it!        
    }
    if (is_page_template( array('templates/template-collections.php') )){
...
function create_post_type_html5()
{
    ...
    register_post_type('presentoirs', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Présentoirs', 'saint-honore'), // Rename these to suit
            'singular_name' => __('Présentoir', 'saint-honore'),
            'add_new' => __('Add New', 'saint-honore'),
            'add_new_item' => __('Add New Présentoir', 'saint-honore'),
            'edit' => __('Edit', 'saint-honore'),
            'edit_item' => __('Edit Présentoir', 'saint-honore'),
            'new_item' => __('New Présentoir', 'saint-honore'),
            'view' => __('View Présentoir', 'saint-honore'),
            'view_item' => __('View Présentoir', 'saint-honore'),
            'search_items' => __('Search Présentoir', 'saint-honore'),
            'not_found' => __('No Présentoir found', 'saint-honore'),
    ...
    register_taxonomy(
        ...
        'presentoirs',
        array(
            'label'  => __('Custom Taxonomy', 'saint-honore'),
            'labels' =>
                array(
                    'name' 			=> __('Custom Taxonomies', 'saint-honore'),
                    'singular_name' => __('Custom Taxonomy', 'saint-honore'),
                    'all_items' 	=> __('All Custom Taxonomy', 'saint-honore'),
                    'edit_item' 	=> __('Edit Custom Taxonomy', 'saint-honore'),
                    'view_item' 	=> __('See Custom Taxonomy', 'saint-honore'),
                    'update_item' 	=> __('Update Custom Taxonomy', 'saint-honore'),
                    'add_new_item' 	=> __('Add Custom Taxonomy', 'saint-honore'),
                    'new_item_name' => __('New Custom Taxonomy', 'saint-honore'),
                    'search_items' 	=> __('Search Custom Taxonomy', 'saint-honore'),
                    'popular_items' => __('Popular Custom Taxonomy', 'saint-honore')
                ),
            'hierarchical' => true,
            'public' => true,
            'has_archive' => true,
    ...
    // register_taxonomy_for_object_type('category', 'html5-blank'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('taxonomy-mannequins', 'mannequins');
    register_post_type('mannequins', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Mannequins', 'saint-honore'), // Rename these to suit
            'singular_name' => __('Mannequin', 'saint-honore'),
            'add_new' => __('Add New', 'saint-honore'),
            'add_new_item' => __('Add New Mannequin', 'saint-honore'),
            'edit' => __('Edit', 'saint-honore'),
            'edit_item' => __('Edit Mannequin', 'saint-honore'),
            'new_item' => __('New Mannequin', 'saint-honore'),
            'view' => __('View Mannequin', 'saint-honore'),
            'view_item' => __('View Mannequin', 'saint-honore'),
            'search_items' => __('Search Mannequin', 'saint-honore'),
            'not_found' => __('No Mannequin found', 'saint-honore'),
            'not_found_in_trash' => __('Mannequin Not found in Trash', 'saint-honore')
            ),
            'public' => true,
