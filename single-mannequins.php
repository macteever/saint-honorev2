<?php get_header(); ?>
	<main role="main" class="single-main">
		...
		<?php if (have_posts()): while (have_posts()) : the_post(); ?>
			...
			//get term 
			$ajax_term = get_the_terms($post_id, 'taxonomy-mannequins');
			// print_r($ajax_term);
			?>
			<!-- article -->
				...
				<div class="row align-items-end p-relative">
					...
					<div class="col-xl-7 col-lg-8 col-md-8 col-12 p-relative ajax-thumbnail">
						...
						<div class="single-btn-back">
							<?php
							// $terms = wp_get_post_terms( $post->ID, 'taxonomy-mannequins');
							// foreach ($terms as $term) {?>
								<!-- <a class="btn-black-left" href="<?php // echo get_term_link( $term->slug, 'taxonomy-mannequins'); ?>"><?php // _e('Retour','saint-honore') ?></a> -->
							<?php //	}	?>
